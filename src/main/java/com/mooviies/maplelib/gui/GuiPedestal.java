...
public class GuiPedestal extends GuiContainer {
    ...
    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(MapleMod.MODID, "textures/gui/pedestal.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String name = MapleBlocks.pedestal.getLocalizedName();
