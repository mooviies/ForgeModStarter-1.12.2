...
public class MyItemSeeds extends ItemSeeds {
    ...
    private static ArrayList<MyItemSeeds> items = new ArrayList<>();

    public MyItemSeeds(String name, BlockCropsSetter blockCropsSetter, Block ... soils) {
        super(null, null);
        initialize(name, blockCropsSetter, EnumPlantType.Crop, soils);
    }

    public MyItemSeeds(String name, BlockCropsSetter blockCropsSetter, EnumPlantType type, Block ... soils) {
        super(null, null);
    ...
    @Override
    public MyItemSeeds setCreativeTab(CreativeTabs tab) {
